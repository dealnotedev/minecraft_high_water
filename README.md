...
<img src="pack.png" width="128" alt="High Water icon" />
...
![Type](https://img.shields.io/badge/type-Data%20Pack-blue)
![Pack format](https://img.shields.io/badge/pack__format-107-orange)
...
Датапак, що перетворює Звичайний світ на один величезний океан. Рівень моря піднято до **y=256**, вода заповнює все нижче. Ванільний рельєф і біоми генеруються як завжди — просто затоплені. Гори стають рідкісними підводними хребтами; суші немає.

Створено для виживання на човні, челенджів «лише океан» і хардкорних проходжень, де кожен блок землі — на вагу золота.

### Можливості
- 🌊 **Затоплений світ** — рівень моря 63 → 256, суцільний океан.
